...
export default function WelcomeRibbon() {
    const [show, setShow] = useState(useSelector(selectIsLoggedIn));
        ...
        <>
            {
                loggedInUser && show ?
                    <div className="hidden md:flex px-10 py-1 bg-white justify-between">
                        ...
                        <button className="cursor-pointer border hover:border-gray-500 hover:bg-fuchsia-100 rounded w-6 h-6 text-center align-middle flex justify-center items-center" onClick={(e) => setShow(false)}>
